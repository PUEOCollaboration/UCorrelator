#ifndef PUEO_UCORRELATOR_PROBABILITY_MAP
#define PUEO_UCORRELATOR_PROBABILITY_MAP
  ...
  namespace UCorrelator
  {
    ...
    class ProbabilityMap   : public TObject 
    {
      public: 
        ...
        int add(const EventSummary * sum , const nav::Attitude * pat, pol::pol_t pol, int peak = 0, double weight = 1, TFile * debugfile = 0); 
         ...
         *
         */
        double computeContributions(const EventSummary * sum, const nav::Attitude * pat, 
        ...
        double overlap(const EventSummary * sum , const nav::Attitude * pat, 
                       pol::pol_t pol, int peak = 0, bool normalized = false, 
                       double weight = 1, 

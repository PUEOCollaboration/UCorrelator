#ifndef PUEO_UCORRELATOR_ANALYSIS_CONFIG_H
#define PUEO_UCORRELATOR_ANALYSIS_CONFIG_H
  ...
  namespace UCorrelator
  {
    ...
    class AnalysisConfig
    {
      public: 
        ...
        pol::pol_t start_pol;  /// Start polarization for Analyer (kHORIZONTAL if you want just hpol or both, kVERTICAL if you want just vpol)
        pol::pol_t end_pol;  /// End polarization for Analyer (kHORIZONTAL if you want just hpo. kVERTICAL if you want just vpol or both.)
        ...
        /** option to turn off using antennas marked as not usable by flight info. default is OFF (use all antennas) */

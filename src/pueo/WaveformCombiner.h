#ifndef PUEO_UCORRELATOR_WAVEFORM_COMBINER_H
#define PUEO_UCORRELATOR_WAVEFORM_COMBINER_H
  ...
  namespace UCorrelator
  {
    ...
    class WaveformCombiner
    {
      ...
      public: 
        ...
        WaveformCombiner(int nantennas = 15, int npad = 3, bool useUnfiltered = true, bool deconvolve = false, const ResponseManager * response = 0); 
      ...
      private: 
        ...
        const AnalysisWaveform * wf(const FilteredEvent*, int ant, pol::pol_t pol); 
